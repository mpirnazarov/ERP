...
<c:set var="pageTitle" scope="request" value="Edit Language Summary"/>
<%
...
<jsp:include flush="true" page="/WEB-INF/views/jsp/shared/erpUserHeader.jsp"></jsp:include>
    ...
    <div class="mainBodyBlock">
        ...
        <form:form modelAttribute="lang" cssClass="form-horizontal" method="post">
            <h2 class="headerText">Edit Language Summary</h2>
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5"><form:select path="reading" items="${rankings}"
                                                       cssClass="form-control text-box single-line"/></div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Writing: <font color='red'>*</font></label>
                    <div class="col-lg-5"><form:select path="writing" items="${rankings}"
                                                       cssClass="form-control text-box single-line"/></div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Speaking: <font color='red'>*</font></label>
                    <div class="col-lg-5"><form:select path="speaking" items="${rankings}"
                                                       cssClass="form-control text-box single-line"/></div>
                </div>
            </div>
            <div class="form-group">
