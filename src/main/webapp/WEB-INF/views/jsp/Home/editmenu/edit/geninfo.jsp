            ...
            <div class="tab-content">
                ...
                <div id="headerinfo" class="tab-pane fade in active">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5"><form:input placeholder="Last name" required="true"
                                                                      ...
                                                                      path="lastName[2]"
                                                                      value="${person.lastName[2]}"/></div>
                                </div>
                                <div class="form-group"><label class="control-label col-md-3">First name: <font
                                        color='red'>*</font></label>
                                    <div class="col-lg-5"><form:input placeholder="First name" required="true"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="firstName[2]"
                                                                      value="${person.firstName[2]}"/></div>
                                </div>
                                <div class="form-group"><label class="control-label col-md-3">Fathers name: </label>
                                    <div class="col-lg-5"><form:input placeholder="Fathers name"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="fathersName[2]"
                                                                      value="${person.fathersName[2]}"/></div>
                                </div>
                                <div class="form-group"><label class="control-label col-md-3">Address: <font
                                        color='red'>*</font></label>
                                    <div class="col-lg-5"><form:input placeholder="Address" required="true"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="address[2]"
                                                                      value="${person.address[2]}"/></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5"><form:input placeholder="Фамилия" required="true"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="lastName[0]"
                                                                      value="${person.lastName[0]}"/></div>
                                </div>
                                <div class="form-group"><label class="control-label col-md-3">Имя: <font
                                        color='red'>*</font></label>
                                ...
                                <div class="form-group"><label class="control-label col-md-3">Отчество: </label>
                                    <div class="col-lg-5"><form:input placeholder="Отчество"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="fathersName[0]"
                                                                      value="${person.fathersName[0]}"/></div>
                                </div>
                                <div class="form-group"><label class="control-label col-md-3">Адрес: <font
                                        color='red'>*</font></label>
                                    <div class="col-lg-5"><form:input placeholder="Адрес" required="true"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="address[0]"
                                                                      value="${person.address[0]}"/></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5"><form:input placeholder="Familiya" required="true"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="lastName[1]"
                                                                      value="${person.lastName[1]}"/></div>
                                </div>
                                <div class="form-group"><label class="control-label col-md-3">Ism: <font
                                        color='red'>*</font></label>
                                ...
                                <div class="form-group"><label class="control-label col-md-3">Sharf: </label>
                                    <div class="col-lg-5"><form:input placeholder="Sharf"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="fathersName[1]"
                                                                      value="${person.fathersName[1]}"/></div>
                                </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group"><label class="control-label col-md-3">Passport Number: <font
                            ...
                            <div class="col-lg-5">
                                <form:input path="passportNumber" placeholder="AA01234567"
                                            value="${person.passportNumber}" required="true"
                                            cssClass="form-control single-line" maxlength="9"/>
                                <form:errors path="PassportNumber" cssClass="error field-validation-error"/>
                            </div>
                        </div>
                        <div class="form-group"><label class="control-label col-md-3">Is Political: <font
                                color='red'>*</font></label>
                            <div class="col-lg-5">
                        ...
                        <div class="form-group"><label class="control-label col-md-3">Entry date: <font
                                color='red'>*</font></label>
                            <div class="col-lg-5">
                        ...
                        <div class="form-group"><label class="control-label col-md-3">Vacation days: </label>
                            <div class="col-lg-5"><c:out
                                    value="${person.vacationDaysLeft} / ${person.vacationDaysAll}"></c:out></div>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div id="personalinfo" class="tab-pane fade">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group"><label class="control-label col-md-4">Birth place: </label>
                                    <div class="col-lg-5"><form:input cssClass="form-control text-box single-line"
                                                                      path="personalInfo.birthPlace[2]"
                                                                      value="${person.personalInfo.birthPlace[2]}"/></div>
                                </div>
                            </div>
                        </div>
                        <div id="piru" class="tab-pane fade">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group"><label class="control-label col-md-4">Место рождения: </label>
                                    <div class="col-lg-5"><form:input cssClass="form-control text-box single-line"
                                                                      path="personalInfo.birthPlace[0]"
                                                                      value="${person.personalInfo.birthPlace[0]}"/></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group"><label class="control-label col-md-4">Tug'ilgan joyi: </label>
                                    <div class="col-lg-5"><form:input placeholder="Birth place:"
                                                                      cssClass="form-control text-box single-line"
                                                                      path="personalInfo.birthPlace[1]"
                                                                      value="${person.personalInfo.birthPlace[1]}"/></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <hr/>
                    <div class="form-horizontal">
                        <div class="form-group"><label class="control-label col-md-4">Date of Birth: <font
                                color='red'>*</font></label>
                            <div class="col-lg-5">
                                <form:input path="personalInfo.dateOfBirth" type="date"
                                            value="${person.personalInfo.dateOfBirth}"
                                            cssClass="form-control text-box single-line requiredDate"/>
                        ...
                        <div class="form-group"><label class="control-label col-md-4">Home phone: </label>
                            <div class="col-lg-5">
                                <form:input path="personalInfo.homePhone" placeholder="998971234546"
                                            value="${person.personalInfo.homePhone}"
                        ...
                        <div class="form-group"><label class="control-label col-md-4">Mobile phone: </label>
                            <div class="col-lg-5">
                                <form:input path="personalInfo.mobilePhone" placeholder="998971234546"
                                            value="${person.personalInfo.mobilePhone}"
                                            type="tel" pattern="[0-9]{12}"
                                            title="Phone Number with 12 digits (998971112233)"
                                            cssClass="form-control single-line"/>
                        ...
                        <div class="form-group"><label class="control-label col-md-4">E-mail (company): <font
                            ...
                            <div class="col-lg-5">
                                <form:input path="personalInfo.emailCompany" placeholder="test@lgcns.uz"
                                            value="${person.personalInfo.emailCompany}" type="email"
                        ...
                        <div class="form-group"><label class="control-label col-md-4">E-mail (personal): <font
                                color='red'>*</font></label>
                            <div class="col-lg-5">
                                <form:input path="personalInfo.emailPersonal" placeholder="test@lgcns.uz"
                                            value="${person.personalInfo.emailPersonal}"
                                            cssClass="form-control single-line"/>
