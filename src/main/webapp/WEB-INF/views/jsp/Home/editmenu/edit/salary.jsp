        ...
        <form:form modelAttribute="salaryVM" cssClass="form-horizontal" method="post">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group"><label class="control-label col-md-3">PIT: </label>
                    <div class="col-lg-5"><label class="control-label col-md-3"><form:input value="${salaryVM.pit}"
                                                                                            path="pit" placeholder="PIT"
                                                                                            cssClass="form-control text-box single-line"/>%</label>
                    </div>
                </div>
                <div class="form-group"><label class="control-label col-md-3">INPS: </label>
                    <div class="col-lg-5"><label class="control-label col-md-3"><form:input value="${salaryVM.inps}"
                                                                                            path="inps"
                                                                                            placeholder="INPS"
                                                                                            cssClass="form-control text-box single-line"/>%</label>
                    </div>
                ...
                <div class="form-group"><label class="control-label col-md-3">PF: </label>
                    <div class="col-lg-5"><label class="control-label col-md-3"><form:input value="${salaryVM.pf}"
