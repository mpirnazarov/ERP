...
<c:set var="pageTitle" scope="request" value="Hierarchy"/>
...
<jsp:include flush="true" page="/WEB-INF/views/jsp/shared/erpUserHeader.jsp"></jsp:include>
    ...
    <div class="mainBodyBlock">
        ...
        <link rel="stylesheet" href="${dataCss}"/>
        <spring:url value="/resources/core/js/go.js" var="goJs"></spring:url>
        <script src="${goJs}"></script>
        <script src="${dataInspector}"></script>
...
//                    });
        ...
        <div id="sample">
            <div id="myDiagramDiv" style="background-color: #FFFFFF; border: solid 1px black; height: 500px;"></div>
            <div>
                <div id="myInspector">
            ...
            <div>
                ...
                <textarea id="mySavedModel" style="width:100%;height:250px; color: #1a1a1a; visibility: hidden">
                    ${jsonData}
                    <%--{ "class": "go.TreeModel",
                      "nodeDataArray": [
