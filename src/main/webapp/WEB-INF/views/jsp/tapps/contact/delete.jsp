...
<c:set var="pageTitle" scope="request" value="Delete contact in customer organizations"/>


<jsp:include flush="true" page="/WEB-INF/views/jsp/shared/erpUserHeader.jsp"></jsp:include>
<div class="col-sm-9 col-md-offset-1">
    <div class="col-lg-8 col-lg-offset-2">
        <h1 class="page-header">Delete contact in customer organizations</h1>
        <form:form modelAttribute="viewModel" cssClass="form-horizontal" method="post" action="/Contacts/Delete"
                   id="myForm">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <form:select path="organizationId" cssClass="form-control text-box single-line" disabled="true"
                                     items="${organizations}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <form:input path="mobilePhone" placeholder="Mobile phone number" type="tel" disabled="true"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <form:input path="workPhone" placeholder="Mobile phone number" type="tel" disabled="true"
                                    cssClass="telPhone form-control text-box single-line"/>
                        <form:errors path="MobilePhone" cssClass="error field-validation-error"/>
                    </div>
                </div>
