            ...
            <div class="w3-container b3form">
                <div class="form-header">
                    ...
                    <div class="input-group" style="width: 100%; margin-top: 1%">
                        ...
                        <form:select class="form-control" aria-describedby="saerchtype-addon" style="width: 40%" path="absenceType" id="absenceType" items="${absenceType}">
                ...
                <div class="form-footer" style="margin-bottom: 5%">
                    ...
                    <div class="input-group" style="width: 100%; margin-top: 2%">
                        ...
                        <form:input type="date" class="form-control" style="width:36%" name="start"  path="start" id="start"/>
                    ...
                    <div class="btn-group" role="group" aria-label="..." style="margin-left: 40%; margin-top: 3%">
                        <input id="tv" type="submit" name="Save" value="Save" class="btn btn-success"/>
